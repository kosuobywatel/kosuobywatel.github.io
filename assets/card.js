...
// Sprawdzanie i ustawienie daty aktualizacji
if (localStorage.getItem("update") == null) {
  let newDate = new Date();
  localStorage.setItem("update", newDate.toLocaleDateString("pl-PL", options));
}
...
// Ustawienie tła obrazu i innych danych
...
// Funkcja ustawiająca dane w elemencie
